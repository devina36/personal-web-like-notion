...
export default function () {
  return (
    <>
      <Header />
      <ImgProject urlImg={'/assets/my-notess.png'} icon={'📝'} key={'notes'} />
      <section className="contain my-20">
        <div className="w-full px-4 sm:px-28 ">
          <div className="flex flex-col sm:flex-row justify-between">
            <div className=" sm:w-4/5">
              <h2 className="text-theme font-inter font-bold text-3xl mb-2">Simple notes reactjs</h2>
              <p className="text-theme sm:w-4/5">This is simple notes for managing to do list</p>
